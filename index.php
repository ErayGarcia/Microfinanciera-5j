                                ...
                                <div class="card-body p-md-5 mx-md-4">
                                    ...
                                    <form method="post" action="">
                                        ...
                                        <div class="form-outline mb-4">
                                            <input id="RFC" type="RFC" class="form-control" placeholder="Ingresar RFC" name="RFC" />
                                        </div>
                                        <div class="form-outline mb-4">
                                            <input id="contrasena" type="contraseña" class="form-control" placeholder="Ingresar contraseña" name="contraseña" />
                                        </div>
